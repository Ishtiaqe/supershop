  ...
  !(function () {
    ...
    async function R(e, t, s, a) {
      ...
      for (let n of await e.keys(t, r))
        if (i === v(n.url, s)) return e.match(n, a);
    }
    class x {
      constructor() {
    ...
    class L {
      ...
      async cachePut(e, t) {
        ...
        if (!t) throw new h("cache-put-with-no-response", { url: b(a.url) });
        ...
        let { cacheName: r, matchOptions: n } = this._strategy,
          ...
          l = c ? await R(o, a.clone(), ["__WB_REVISION__"], n) : null;
        try {
      ...
      _useDefaultCacheabilityPluginIfNeeded() {
        ...
        for (let [s, a] of this.plugins.entries())
          a !== k.copyRedirectedCacheableResponsesPlugin &&
            (a === k.defaultPrecacheCacheabilityPlugin && (e = s),
            a.cacheWillUpdate && t++);
        0 === t
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`);
    ...
    let N = () => (i || (i = new U()), i);
    s(80);
    let P = (e) => (e && "object" == typeof e ? e : { handle: e });
    class I {
      constructor(e, t, s = "GET") {
        (this.handler = P(t)), (this.match = e), (this.method = s);
      }
      setCatchHandler(e) {
    ...
    let q = () => (
      r || ((r = new M()).addFetchListener(), r.addCacheListener()), r
    );
    function K(e, t, s) {
      let a;
      if ("string" == typeof e) {
        let i = new URL(e, location.href);
        a = new I(({ url: e }) => e.href === i.href, t, s);
      } else if (e instanceof RegExp) a = new S(e, t, s);
      else if ("function" == typeof e) a = new I(e, t, s);
      else if (e instanceof I) a = e;
      else
    ...
    class F extends T {
      ...
      async _getNetworkPromise({
        ...
        return (
          e && clearTimeout(e), (i || !r) && (r = await a.cacheMatch(t)), r
        );
      }
    }
    function H(e) {
        ...
        "function" == typeof (t = e)
          ? t !== IDBDatabase.prototype.transaction ||
            ...
            ? (
              ...
              ? function (...e) {
                  return t.apply(Z(this), e), Y($.get(this));
                }
              : function (...e) {
                  return Y(t.apply(Z(this), e));
                }
            : function (e, ...s) {
                let a = t.call(Z(this), e, ...s);
                return Q.set(a, e.sort ? e.sort() : [e]), Y(a);
              }
          ...
          ? new Proxy(t, X)
          : t;
      return s !== e && (J.set(e, s), z.set(s, e)), s;
    }
    let Z = (e) => z.get(e),
      ee = ["get", "getKey", "getAll", "getAllKeys", "count"],
      et = ["put", "add", "delete", "clear"],
      es = new Map();
    function ea(e, t) {
      if (!(e instanceof IDBDatabase && !(t in e) && "string" == typeof t))
        return;
      if (es.get(t)) return es.get(t);
    ...
    (X = {
      ...(c = X),
      get: (e, t, s) => ea(e, t) || c.get(e, t, s),
      has: (e, t) => !!ea(e, t) || c.has(e, t),
    }),
      s(550);
    ...
    class en {
      ...
      async setTimestamp(e, t) {
        let s = {
          ...
          a = (await this.getDb()).transaction(ei, "readwrite", {
            durability: "relaxed",
          });
      ...
      async getTimestamp(e) {
        let t = await this.getDb(),
          s = await t.get(ei, this._getId(e));
      ...
      async expireEntries(e, t) {
        ...
        let n = [];
        for (let e of i) await s.delete(ei, e.id), n.push(e.url);
        return n;
      }
      _getId(e) {
    ...
    class ec {
      ...
      _getCacheExpiration(e) {
        ...
        return (
          t ||
            ((t = new eo(e, this._config)), this._cacheExpirations.set(e, t)),
          t
        );
      }
    ...
    (e = [
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/1021-eb3661c9304119d9.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/1110-2ed89a59b2ab4878.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/120-51f932db2e9fbb72.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/1530-036cc4f6a4abb75a.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/1652-0d580177f4b6d9e9.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/1865-c741c85151ff5c02.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/1923-36b98dc4bbc4d881.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/1928-3c37e3b8059d58f9.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/2117-6acb8a690f11ec97.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/2562-f6fe45867731dc2f.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/3218-ec5b3bbcb8cbd9d2.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/337-d082090e5ba5cdc2.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/353-d01b093725463d4f.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/3714-2b19f60ce7ca6022.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/3745-b4caa47a73360baf.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/4046-4b8f692c87e8f606.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/4329-c8fcac3d2d6c0a2e.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/4655-105124ecb8ee7af8.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/4766-a62fb6fb224af5ad.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/4787-a2aa80e2d414babb.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/5043-5a180a1c6ef8087b.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/5545-7d0fcf4d60479654.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/5945-65db21bc4775d9d4.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/6035-a7f708124e8fd9f6.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/6478-8b6f228be0eb5561.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/6537-cbedd58c137049bf.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/6819-ed7c8c92bf9fd9c5.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/6835-c8eb564db87bee2a.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/7076-d84b838bd85211a8.js",
      },
      {
        revision: "d91db0ad83751138",
        url: "/_next/static/chunks/7640.d91db0ad83751138.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/7932-f30ee59448f07322.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/8310-84f213cb3fa29a4c.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/8465-dbeec7622a2bb7ca.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/8646-556b5c0e3d8b1dfc.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/9728-0647c61613c38891.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/9981-987f8a7ef7c4982e.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/_not-found/page-06af1293de5a9f32.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/admin/tenants/page-032507bad141245b.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/auth/callback/page-61694d87756bb346.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/dashboard/brands/page-79c23a69f993b209.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/dashboard/catalog/page-3e96a81a0f098d29.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/dashboard/categories/page-49cb7fd1884dd7aa.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/dashboard/inventory/page-4aaaefdd363ba96c.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/dashboard/medicine-database/page-a16a34838f0c5cde.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/dashboard/page-4ba1d5dbd262acc7.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/dashboard/pos/page-ad04cd34c18b3aad.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/dashboard/sales/page-9592ac491c64fb0b.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/layout-6050feae4bea52c4.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/login/page-d968bc4bfcff224b.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/offline/page-d810abff6a238fbf.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/page-953aafc294d54cf0.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/profile/page-2772cc039dead6f4.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/tenant/setup/page-f1d39979cc50e451.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/test-offline-medicine/page-1ac746f907e0dd77.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/app/test-offline-reload/page-e8e7651400f2f330.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/eaa9a3dd-f34790a0b61c5da3.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/fd9d1056-7af7e8d06eb298e0.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
      ...
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/main-cbe8f14c080ab69e.js",
      },
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
      ...
      {
        revision: "iG6nEsn8eLBCinHCjMwns",
        url: "/_next/static/chunks/webpack-a2e7ae5c306d5ea5.js",
      },
      {
        revision: "453e1ee09889eaf2",
        url: "/_next/static/css/453e1ee09889eaf2.css",
      },
      {
        revision: "6310079bf1ae7bebeb6a2135896e4564",
        url: "/_next/static/iG6nEsn8eLBCinHCjMwns/_buildManifest.js",
      },
      {
        revision: "b6652df95db52feb4daf4eca35380933",
        url: "/_next/static/iG6nEsn8eLBCinHCjMwns/_ssgManifest.js",
      },
      {
      ...
      {
        revision: "e547007ef602958da136028757577881",
        url: "/android-chrome-192x192.png",
      },
      {
        revision: "30738ee6a3c63c6e3c4e25db09ed4264",
        url: "/android-chrome-512x512.png",
      },
      {
        revision: "c819990a24e7806c6b50ac33a803a815",
        url: "/apple-touch-icon.png",
      },
      { revision: "536ee9d3b95cbbf023047f978a3a03e4", url: "/favicon.ico" },
      { revision: "1fa2a619c541833eece1b4dcc2fbfa92", url: "/manifest.json" },
      { revision: "e46d102a7f842c59463a55d797bec053", url: "/offline.html" },
      { revision: "73eccd99c03ec623ee98ccbd0a645a8d", url: "/sw.js" },
    ]),
      N().precache(e),
      (t = void 0),
      K(new A(N(), t)),
      self.addEventListener("activate", (e) => {
        let t = f();
        e.waitUntil(O(t).then((e) => {}));
      }),
      K((e) => {
        let { url: t } = e;
        return (
          t.origin.startsWith("https://fonts.googleapis.com") ||
          t.origin.startsWith("https://fonts.gstatic.com")
        );
      }, new B({ cacheName: "google-fonts", plugins: [new ec({ maxEntries: 4, maxAgeSeconds: 31536e3 })] })),
      K((e) => {
        let { request: t } = e;
        return "image" === t.destination;
      }, new B({ cacheName: "images", plugins: [new ec({ maxEntries: 60, maxAgeSeconds: 2592e3 })] })),
      K((e) => {
        let { url: t } = e;
        return (
          t.pathname.startsWith("/api") && t.origin.includes("localhost:8000")
        );
      }, new F({ cacheName: "api-cache", networkTimeoutSeconds: 10, plugins: [new ec({ maxEntries: 200, maxAgeSeconds: 86400 })] })),
      K((e) => {
        let { request: t } = e;
        return "navigate" === t.mode;
      }, new F({ cacheName: "pages", plugins: [{ handlerDidError: async () => caches.match("/offline") }] })),
