    ...
    <main className="min-h-screen flex items-center justify-center bg-background">
      <div className="w-full max-w-md px-6">
        <div className="rounded-2xl border border-border bg-card p-8 shadow-sm">
          ...
          {error && (
            <Alert type="error" message={error} className="mb-6 rounded-lg" showIcon />
          )}
          ...
          <Form onFinish={submit} layout="vertical" size="large">
            ...
            <Form.Item className="mb-0">
              <Button type="primary" htmlType="submit" block loading={loading} className="h-12 rounded-lg font-semibold text-base">
